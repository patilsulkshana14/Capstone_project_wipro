...
public class PageClass 
{
	...
	By checkitem=By.xpath("//*[@id=\"cart\"]/button");
	...
	By remove=By.xpath("//*[@id=\"content\"]/form/div/table/tbody/tr[1]/td[4]/div/span/button[2]");
	...
	public void loginUser() {
	    ...
	    driver.findElement(name).sendKeys("sp@gmail.com");
	...
	public void registerNewUser(String firstName, String lastName, String emailId, String telephone, String password, String confirmPassword) {
        driver.findElement(acc).click();
        driver.findElement(regi).click();

        driver.findElement(uname).clear();
        driver.findElement(uname).sendKeys(firstName);

        driver.findElement(lname).clear();
        driver.findElement(lname).sendKeys(lastName);

        driver.findElement(name).clear();
        driver.findElement(name).sendKeys(emailId);

        driver.findElement(tel).clear();
        driver.findElement(tel).sendKeys(telephone);

        driver.findElement(pass).clear();
        driver.findElement(pass).sendKeys(password);

        driver.findElement(passcon).clear();
        driver.findElement(passcon).sendKeys(confirmPassword);
	...
	public void forgetpass()
	{
		...
		driver.findElement(name).clear();
		driver.findElement(name).sendKeys("disha23@gmail.com");
	...
	public void updateAddress(String firstName, String lastName, String shipAddress, String zipCode, String countryName, String stateName) {
	    driver.findElement(acc).click();
	    ...
	    driver.findElement(shipadd).sendKeys(shipAddress);
	    ...
	    c2.selectByVisibleText(stateName);
